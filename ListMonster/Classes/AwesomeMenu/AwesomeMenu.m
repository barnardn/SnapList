...
- (UIImage *)imageForDefaultImageName:(NSString *)imageName;
@end
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray defaultOptions:(NSDictionary *)defaults
{
    ...
    if (self) {
        ...
        BOOL useDefaultAddButton = [[defaults objectForKey:AwesomeMenuUseDefaultAddButtonKey] boolValue];
        if (useDefaultAddButton) {
            _addButton = [[AwesomeMenuItem alloc] initWithImage:[self imageForDefaultImageName:@"bg-addbutton.png"]
                                               highlightedImage:[self imageForDefaultImageName:@"bg-addbutton-highlighted.png"]
                                                   ContentImage:[self imageForDefaultImageName:@"icon-plus.png"]
                                        highlightedContentImage:[self imageForDefaultImageName:@"icon-plus-highlighted.png"]];
            
        } else {
            _addButton = [[AwesomeMenuItem alloc] initWithImage:[UIImage imageNamed:[defaults valueForKey:AwesomeMenuNormalBackgroundImageKey]]
                                               highlightedImage:[UIImage imageNamed:[defaults valueForKey:AwesomeMenuHighlightedBackgroundImageKey]]
                                                   ContentImage:[UIImage imageNamed:[defaults valueForKey:AwesomeMenuNormalContentImageKey]]
                                        highlightedContentImage:[UIImage imageNamed:[defaults valueForKey:AwesomeMenuHighlightedContentImageKey]]];
        }
...
{
    return [self initWithFrame:frame menus:aMenusArray defaultOptions:@{ AwesomeMenuUseDefaultAddButtonKey : @(YES) }];
...
- (void)AwesomeMenuItemTouchesEnd:(AwesomeMenuItem *)item
{
    ...
    // rotate "add" button
    if (![self disableAddButtonRotation]) {
    ...
    {
        if ([self updateAddButtonWithSelectedButton]) {
            [[_addButton contentImageView] setImage:[[item contentImageView] image]];
            [[_addButton contentImageView] setHighlightedImage:[[item contentImageView] image]];
        }
...
- (UIImage *)imageForDefaultImageName:(NSString *)imageName
{
    NSString *path = [[NSBundle mainBundle] pathForResource:imageName ofType:nil inDirectory:@"AwesomeMenuDefaultImages"];
